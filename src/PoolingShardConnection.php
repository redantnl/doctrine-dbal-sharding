 ...
 *    ),
 *    'shardChooser' => 'Doctrine\DBAL\Sharding\ShardChooser\MultiTenantShardChooser',
 * ));
...
class PoolingShardConnection extends Connection
{
    ...
    public function __construct(
        ...
        if (! isset($params['shardChooser'])) {
            throw new InvalidArgumentException("Missing Shard Chooser configuration 'shardChooser'");
        }

        if (is_string($params['shardChooser'])) {
            $params['shardChooser'] = new $params['shardChooser']();
        }

        if (! ($params['shardChooser'] instanceof ShardChooser)) {
            throw new InvalidArgumentException(
                "The 'shardChooser' configuration is not a valid instance of " . ShardChooser::class
            );
        }
    ...
    public function getHost(): ?string
    {
        ...
        return $params['host'] ?? $this->connectionParameters[0]['host'] ?? null;
    }
    ...
    public function getPort(): ?int
    {
        ...
        return $params['port'] ?? $this->connectionParameters[0]['port'] ?? null;
    }
    ...
    public function getUsername(): ?string
    {
        ...
        return $params['user'] ?? $this->connectionParameters[0]['user'] ?? null;
    }
    ...
    public function getPassword(): ?string
    {
        ...
        return $params['password'] ?? $this->connectionParameters[0]['password'] ?? null;
    }
